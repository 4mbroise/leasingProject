...
SELECT * from leasing.employee WHERE memberId = ?;

INSERT INTO leasing.employee (name, surname, socialSecurityId, driverLicenseId, adress) VALUES (?,?,?,?,?);

SELECT MAX(memberId) FROM leasing.employee AS lastID;
